...
- Use the Lavaan package in R for the bootstrapping approach.

- Create a path model diagram using your preferred software.

- Write-up your results using APA style and provide a discussion of the findings. If there are any differences between your analysis and theirs, describe them. Additionally, share your thoughts on how the authors shared their data.
